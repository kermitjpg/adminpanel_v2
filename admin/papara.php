            ...
            <div class="container-fluid px-1 py-1">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-sm-2 col-lg-2">
                        <div class="card text-white text-center bg-success bg-gradient mb-3" style="max-width: 500px;">
                    ...
                    <div class="col-sm-2 col-lg-2">
                        <div class="card text-white text-center bg-danger bg-gradient mb-3" style="max-width: 500px;">
                    ...
                    <div class="col-sm-2 col-lg-2">
                        <div class="card text-white text-center bg-warning bg-gradient mb-3" style="max-width: 500px;">
